...
def main():
    ...
    #start_date = input("Entrer Study Start Date (YYYY-MM-DD):")
    #plot_start_date = input("Entrer Study Start Date (YYYY-MM-DD):")
    start_date = get_date("Select Start Date for Data", max_days)
    plot_start_date = get_date("Select Plot Start Date", max_days)
